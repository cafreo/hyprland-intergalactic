...
alias yayf="pacmirrors; yay -Suy --devel; flatpak update; pacclean"
alias yayd="yay -Rns"
...
alias pacmirrors="sudo reflector --country CH,DE --protocol https --sort rate --latest 10 --save /etc/pacman.d/mirrorlist"
# tools
...
alias wshowkeys="wshowkeys -a top -a right -m 66 -F 'ubuntu nerd bold 32' -b '#2A2632' -f '#C8CACC' -s '#EC9B31' -l 40 -t 1400"
# apps
alias lf=lfcd
